...
namespace Dotnet.Docker.Nightly
{
    public class Config
    {
        ...
        private Lazy<string> _cliVersionUrl = new Lazy<string>(() => GetEnvironmentVariable("CLI_VERSION_URL", "https://raw.githubusercontent.com/dotnet/versions/master/build-info/dotnet/cli/rel/1.0.0"));
